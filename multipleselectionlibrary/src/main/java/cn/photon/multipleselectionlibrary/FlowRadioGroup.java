...
public class FlowRadioGroup extends RadioGroup {
    ...
    private FlowRadioGroup.Line mCurrentLine;//记录当前行的

    private int mHorizontalSpace = 2;//水平的间隙
    private int mVerticalSpace = 2;//垂直的间隙
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mHorizontalSpace = DensityUtil.dip2px(getContext(), 10);
        mVerticalSpace = DensityUtil.dip2px(getContext(), 10);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (mCurrentLine == null) {
                //说明一行都没有
                mCurrentLine = new FlowRadioGroup.Line(childMaxWidth, mHorizontalSpace);
        ...
        for (int i = 0; i < mLines.size(); i++) {
            FlowRadioGroup.Line line = mLines.get(i);
